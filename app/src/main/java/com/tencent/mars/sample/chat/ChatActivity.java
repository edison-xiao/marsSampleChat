...
import com.tencent.mars.sample.SampleApplication;
...
public class ChatActivity extends AppCompatActivity implements Observer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!SampleApplication.hasSetUserName) {
                    ...
                    b.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            if (nick.length() > 0 && !nick.trim().equals("")) {
                                SampleApplication.accountInfo.userName = nick.trim();
                                SampleApplication.hasSetUserName = true;
                            } else {
                                return;
                            }
    ...
    public void onClickBtnSend() {
        ...
        entity.setName(SampleApplication.accountInfo.userName);
